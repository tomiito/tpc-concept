...
module.exports = {
  scripts: {
    ...
    destinationFolder: isProduction ? 'production/assets/scripts' : 'docs/assets/scripts',
    destinationName: pkg.name + '.js'
  },
  sass: {
    sources : ['src/app/**/*.scss'],
    destinationFolder: isProduction ? 'production/assets/css' : 'docs/assets/css',
  ...
  images: {
    ...
    destinationFolder : isProduction ? 'production/assets/images' : 'docs/assets/images'
  },
  vendor: {
  ...
  index: {
    ...
    destinationFolder : isProduction ? 'production' : 'docs'
  },
  serve: {
