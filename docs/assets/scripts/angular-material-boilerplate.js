...
angular.module('shared.services.sampleData', [])
  .factory('SampleDataService', function SampleDataService() {
    ...
    var sampleMain = [{
      ...
      pictureUrl: '/tpc-concept/assets/images/demo-course-1.jpg'
    },
      {
        title: 'Why I Use Both WebStorm and Sublime Text',
        pictureUrl: '/tpc-concept/assets/images/demo-course-2.jpg'
      },
      {
        title: 'Mastering Refactoring',
        pictureUrl: '/tpc-concept/assets/images/demo-course-3.jpg'
      },
      {
        title: 'The future of Web Design',
        pictureUrl: '/tpc-concept/assets/images/demo-course-5.jpg'
      },
      {
        title: 'Tips for being better Musician',
        pictureUrl: '/tpc-concept/assets/images/demo-course-6.jpg'
      }
    ];
    ...
    var sampleData = [{
      ...
      },
      {
        ...
        pictureUrl: '/tpc-concept/assets/images/demo-course-4.jpg',
        reviews: 2
      },
      {
        title: 'The future of Web Design',
